...
<body>
    ...
    <div id="right-col">
        <div class="container">
            <div class="img2">
                    <img src="japan(sweet1).png" width="250px" height="350px">
            </div>
            <div class="consnacks">
                <h1>Morinaga Milk Caramel</h1><br>
                <p>65g</p><br>
                <h2>RM8.00</h2>
                <div class="quantity">
