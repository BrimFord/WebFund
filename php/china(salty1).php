...
<body>
    ...
    <div id="right-col">
        <div class="container2">
            <div class="img2">
                    <img src="china(salty1).jpg" width="300px" height="350px">
            </div>
            <div class="consnacks">
                <h1>Wang Wang Snow Cookies</h1><br>
                <p>520g</p><br>
                <h2>RM10.00</h2>
                <div class="quantity">
                    <label for="qty"></label><h3>Quantity:&emsp;</h3>
