...
<body>
    ...
    <div id="right-col">
        <div class="container">
            <div class="img2">
                    <img src="japan(salty1).png" width="250px" height="350px">
            </div>
            <div class="consnacks">
                <h1>Calbee Seaweed & Salt Chips</h1><br>
                <p>80g</p><br>
                <h2>RM6.00</h2><br>
                <div class="quantity">
