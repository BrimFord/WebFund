...
.main-banner #banner{
	background-image: url("img/StoreBanner.png");
...
<body>
		...
		<div id="header" style="z-index: 5">
            ...
            <ul>
                ...
                <li><a href="MainStorePage.php" style="font-size: x-large; font-weight: bold;">Store</a></li>
       ...
       <div class="sidenav">
       <h2>Navigation</h2>
       	<a href="ChinaSnacks.php">Chinese Snacks</a>
  		<a href="JapanSnacks.php">Japanese Snacks</a>
 		<a href="KoreanSnacks.php">Korean Snacks</a>
  		<a href="ThailandSnacks.php">Thai Snacks</a>
		...
		<p style="padding-left: 280px;font-size: 60px;">Welcome to the world of snacks</p>

		<div class ="flex-container">
			<div>
				<a href="japan(sweet1).php">
				<img src="japan(sweet1).png">Moriniaga Milk Caramel<p>RM 8.00</p></a></div>
			<div>
				<a href="japan(salty1).php">
				<img src="japan(salty1).png">Seaweed Salt Chips<p>RM6.00</p></a></div>
			<div>
				<a href="japan(sour1).php">
				<img src="japan(sour1).png">Hoshiume Dried Plums<p>RM5.00</p></a></div>
			<div>
				<a href="japan(spicy1).php">
				<img src="japan(spicy1).png">Kara Mucho<p>RM 7.00</p></a></div>
			<div>
			...
			<div>
				...
				<img src="thai(sweet1).png">Euro Cake<p>RM 12.00</p></a> </div>
			<div>
				<a href="thai(salty1).php">
				<img src="thai(salty1).png">Lays Assorted Nori Seaweed Potato Chips<p>RM5.00</p></a></div>
			<div>
				<a href="thai(sour1).php">
				<img src="thai(sour1).png">Rip Rolls<p>RM3.00</p></a></div>
			<div>
				<a href="thai(spicy1).php">
				<img src="thai(spicy1).png">Bento Squid Seafood Snack<p>RM 3.00</p></a></div>
			<div>
				<a href="china(sweet1).php">
				<img src="china(sweet1).png">White Rabbit<p>RM 5.00</p></a></div>
			<div>
				<a href="china(salty1).php">
				<img src="china(salty1).jpg">Wang Wang Snow Cookies<p>RM10.00</p></a></div>
			<div>
				<a href="china(sour1).php">
				<img src="china(sour1).jpg">Tang Hu Lu<p>RM5.00</p></a></div>
			<div>
				<a href="china(spicy1).php">
				<img src="china(spicy1).jpg">China Spicy Strips<p>RM 4.00</p></a></div>
			<div>
				<a href="msia(sweet1).php">
				<img src="msia(sweet1).png">Iced Gems<p>RM 3.00</p></a> </div>
			<div>
				<a href="msia(salty1).php">
				<img src="msia(salty1).png">Mi-Mi<p>RM2.00</p></a></div>
			<div>
				<a href="msia(sour1).php">
				<img src="msia(sour1).png">Lot 100 Sour+ Gummy<p>RM4.00</p></a></div>
			<div>
				<a href="msia(spicy1).php">
				<img src="msia(spicy1).png">Dahfa Dried Fish Fillet	<p>RM 8.00</p></a></div>
