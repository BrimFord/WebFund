...
.main-banner #banner{
	background-image: url("img/ThailandBanner.png");
...
<body>
       ...
       <div class="sidenav">
        ...
        <p class="welcomeMSG">Welcome to the world of  Thai snacks</p>
        <br><br>
		...
		<div class ="flex-container">
			...
			<div>
				...
				<img src="thai(spicy1).png">Bento Squid Seafood<p>RM 3.00</p></a></div>
